...
START_YEAR=${1:-2080}
END_YEAR=${2:-2092}
OUTPUT_FILE=${3:-"transfer_config_TCo319-DART-2080C_FESOM.yaml"}

# Configuration ===========================================================================

# Case names (edit these for your case)
ICASE_NAME="TCo319-DART-2080C"
...
LOCAL_BASE="/scratch/awicm3-TCo319/${CASE_NAME}/outdata/fesom"
...
Arguments:
  ...
  output_file  Output YAML file (default: transfer_config_TCo319-DART-2080C_FESOM.yaml)
